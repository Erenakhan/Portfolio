...
import findSong from './images/findSong.png';
        ...
        {data.map((project) => (
            <div  key={project.name} className='w-[350px]  md:w-[400px] gap-4    p-4 mx-auto flex  flex-col'>
                ...
                <div className='w-full h-full flex items-center'>
                    ...
                    <a className='hover:scale-110 hover:text-primary text-blue-200' href={project.github}><svg xmlns="http://www.w3.org/2000/svg" fill="none" viewBox="0 0 24 24" strokeWidth="1.5" stroke="currentColor" className="w-7 h-7">
